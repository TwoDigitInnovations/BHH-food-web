      ...
      <nav className="bg-white  relative">
        <div className="mt-2 mx-auto px-4 py-2 md:flex hidden ">
          <div className="hidden flex-1 lg:flex justify-center lg:space-x-8">
            {/* Only show Home and Categories if user is authenticated */}
            {isAuthenticated && (
              <>
                <p
            ...
            <p
              className={`text-[16px] font-medium transition-transform duration-300 hover:-translate-y-[5px]  cursor-pointer ${isAuthenticated ? 'ml-2' : ''} 
    ${selectedTab === "AboutUs"
                  ? "text-custom-green"
                  : "text-custom-black hover:!text-[#2e7d32]"
                }
