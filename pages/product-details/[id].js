              ...
              <div className="flex justify-start items-start w-full">
                <div className="flex flex-col justify-start items-start w-full">
                  ...
                  {user && user._id && !user.documentVerified && (
                    <div className="bg-orange-50 border border-orange-200 rounded-lg md:p-4 p-3 md:mt-16 mt-8 w-full md:w-[400px]">
                      <p className="text-orange-600 font-medium text-center md:text-sm text-xs">
                        Your document verification is pending. Complete verification to view prices & purchase products.
                      </p>
                    </div>
                  )}
